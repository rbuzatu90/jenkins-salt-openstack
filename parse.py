...
parser.add_argument("--tunneling_enabled", required=True, type=str)
parser.add_argument("--tunneling_type", required=True, type=str)
...
config["databases"]["nova"]["db_name"] = args.nova_db_name
config["databases"]["nova"]["username"] = args.nova_db_username
config["databases"]["nova"]["password"] = args.nova_db_password
config["databases"]["keystone"]["db_name"] = args.keystone_db_name
config["databases"]["keystone"]["username"] = args.keystone_db_user
config["databases"]["keystone"]["password"] = args.keystone_db_password
config["databases"]["cinder"]["db_name"] = args.cinder_db_name
config["databases"]["cinder"]["username"] = args.cinder_db_user
config["databases"]["cinder"]["password"] = args.cinder_db_password
config["databases"]["glance"]["db_name"] = args.glance_db_name
config["databases"]["glance"]["username"] = args.glance_db_user
config["databases"]["glance"]["password"] = args.glance_db_password
config["databases"]["neutron"]["db_name"] = args.neutron_db_name
config["databases"]["neutron"]["username"] = args.neutron_db_user
config["databases"]["neutron"]["password"] = args.neutron_db_password
config["databases"]["heat"]["db_name"] = args.heat_db_name
config["databases"]["heat"]["username"] = args.heat_db_user
...
config["neutron"]["tunneling"]["enable"] = args.tunneling_enabled
config["neutron"]["tunneling"]["types"] = args.tunneling_type
